...
```{r}
df_final <- read.csv("./raw_data/viz/ICC_PTR_clean_Data_1stround_CORRECTED_2023_09_21_h16_m11.csv")
...
plot_10_h <- ggplot(order_10_long %>% 
  ...
  labs(title="<p>ICC Heroic - 10 man </p>",x="",y="",
       ...
       subtitle="Data from: 971 logs containing 12,768 heroic encounters")+
...
plot_10_n <- ggplot(order_10_long %>% 
  ...
  labs(title="ICC Normal - 10 man",x="",y=" ",
       caption=c("<p> Buy me a coffee: https:&#47;&#47;www&#46;ko-fi.com/forge","<br ALIGN = 'LEFT'/> THIS IS VERSION 2 - Correction made the 21/09/2023 &#40;dd/mm/yyyy&#41; 09:00 UTC </p>"),
       subtitle="Data from: 482 logs containing 3,175 normal encounters")+
  scale_y_continuous(labels = scales::percent, 
                     limits = c(-0.1,1.16),
                     breaks = seq(0,1,by=0.25)) +
  annotate(
...
plot_25_h <- ggplot(order_25_long %>% 
  ...
  labs(title="ICC Heroic - 25 man",x="",y="",
       ...
       subtitle="Data from: 1,732 logs containing 22,827 heroic encounters")+
  scale_y_continuous(labels = scales::percent, 
                     limits = c(-0.1,1.16),
                     breaks = seq(0,1,by=0.25))+
  annotate(
...
plot_25_n <- ggplot(order_25_long %>% 
  ...
  labs(title="ICC Normal - 25 man",x="",y=" ",
       ...
       subtitle="Data from: 1,097 logs containing 6,162 normal encounters")+
  scale_y_continuous(labels = scales::percent, 
                     limits = c(-0.1,1.16),
                     breaks = seq(0,1,by=0.25)) +
  annotate(
...
image_write(canvas, "./_img/ICCPTR_1stSession.png")
