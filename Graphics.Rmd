...
```{r}
df_final <- read.csv("./raw_data/ICC_PTR_clean_Data2023_09_03_h17_m18.csv")
...
```{r}
boss_order_wing <- c(
  "<span style='color:#464646;'>Marrow</span>" ,  
  "<span style='color:#464646;'>LDW</span>"  ,    
  "<span style='color:#464646;'>Gunship</span>" , 
  "<span style='color:#464646;'>Saurfang</span>" , 
  "<span style='color:#397000;'>Rotface</span>"  ,
  "<span style='color:#397000;'>Festergut</span>" ,
  "<span style='color:#397000;'>Putricide*</span>",
  "<span style='color:#6D0027;'>Council</span>" , 
  "<span style='color:#6D0027;'>Queen</span>"  ,
  "<span style='color:#040A54;'>Valithria</span>", 
  "<span style='color:#040A54;'>Sindra</span>",  
  "<span style='color:#000000;'>LK</span>" 
)
```
...
plot_title  <- magick::image_read("./plot_title.png")
###
title <- ggplot()  +
    vivax_theme_title() + 
  labs(title="",
...
plot_10_h <- ggplot(order_10_long %>% 
  ...
  vivax_theme() + 
  guides(fill="none") +
  labs(title="<p>ICC Heroic - 10 man </p>",x="",y="Pulls",
...
plot_25_h <- ggplot(order_25_long %>% 
  ...
  vivax_theme() + 
  guides(fill="none") +
  labs(title="ICC Heroic - 25 man",x="",y="Pulls",
       caption=c("<p><span style='font-family:forgefooter'>&#xe900;</span> &emsp; Discord: Discfordge &#91;Vivax-Pagle(US)&#93;"," <br> <span style='font-family:forgefooter'>&#xe901;</span> https:&#47;&#47;www&#46;github.com/ForgeGit/ICC_PTR</p>"),
...
```{r} 
canvas <- image_blank(width = 3600, height = 2425)
...
canvas <- image_composite(canvas, plot_10_h_img , offset = "+0+1240",operator = "over")
canvas <- image_composite(canvas,plot_10_n_img  , offset = "+1800+1240",operator = "over")
